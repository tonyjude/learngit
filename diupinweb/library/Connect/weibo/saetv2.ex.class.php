...
class SaeTClientV2
{
	 ...
	 * <br />注意：为防止重复提交，当用户发布的微博消息与上次成功发布的微博消息内容一样时，将返回400错误，给出错误提示：“40025:Error: repeated
	 * weibo text!“。
	 ...
	 * 批量获取当前登录用户的关注人的备注信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/friends/remark_batch
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/direct_messages/destroy_batch
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/favorites/tags/destroy_batch
	 ...
	 *
	 * @access public
	 * @param mixed $ids 必选参数，要删除的tag id，多个id用半角逗号分割，最多10个。或由多个tag
	 ...
	 * 获取用户可能感兴趣的人
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/suggestions/users/may_interested
	 ...
	 * 把某人标识为不感兴趣的人
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/suggestions/users/not_interested
